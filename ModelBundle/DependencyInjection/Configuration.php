    ...
    public function getConfigTreeBuilder()
    {
        ...
        $rootNode->children()
            ...
            ->arrayNode('content_attribute')
                ->addDefaultsIfNotSet()
                ->children()
                    ->scalarNode('class')->defaultValue('PHPOrchestra\ModelBundle\Document\ContentAttribute')->end()
                ->end()
            ->end()
            ...
            ->arrayNode('area')
                ->addDefaultsIfNotSet()
                ->children()
                    ->scalarNode('class')->defaultValue('PHPOrchestra\ModelBundle\Document\Area')->end()
                ->end()
            ->end()
            ->arrayNode('block')
                ->addDefaultsIfNotSet()
                ->children()
                    ->scalarNode('class')->defaultValue('PHPOrchestra\ModelBundle\Document\Block')->end()
                ->end()
            ->end()
            ->arrayNode('site')
                ->addDefaultsIfNotSet()
            ...
            ->arrayNode('field_option')
                ->addDefaultsIfNotSet()
                ->children()
                    ->scalarNode('class')->defaultValue('PHPOrchestra\ModelBundle\Document\FieldOption')->end()
                ->end()
            ->end()
            ->arrayNode('field_type')
                ->addDefaultsIfNotSet()
                ->children()
                    ->scalarNode('class')->defaultValue('PHPOrchestra\ModelBundle\Document\FieldType')->end()
                ->end()
            ->end()
            ...
            ->arrayNode('embed_status')
                ->addDefaultsIfNotSet()
                ->children()
                    ->scalarNode('class')->defaultValue('PHPOrchestra\ModelBundle\Document\EmbedStatus')->end()
                ->end()
            ->end()
            ->arrayNode('theme')
                ->addDefaultsIfNotSet()
            ...
            ->arrayNode('embed_keyword')
                ->addDefaultsIfNotSet()
                ->children()
                    ->scalarNode('class')->defaultValue('PHPOrchestra\ModelBundle\Document\EmbedKeyword')->end()
                ->end()
            ->end()
            ->arrayNode('translated_value')
                ->addDefaultsIfNotSet()
                ->children()
                    ->scalarNode('class')->defaultValue('PHPOrchestra\ModelBundle\Document\TranslatedValue')->end()
                ->end()
            ->end()
        ->end();
